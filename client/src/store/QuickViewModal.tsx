      ...
      >
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-3 sm:p-6 flex flex-col">
            ...
            <div className="flex items-center gap-2 mb-1.5">
              {hasCompareAt ? (
                <>
                  ...
                  <span className="text-lg sm:text-2xl font-bold text-[#253272]">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <div className="flex items-center border border-gray-300 rounded-full overflow-hidden">
                <button
                  ...
                  className="w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center text-[#253272] hover:bg-gray-50 transition-colors text-base sm:text-lg font-medium"
                >
                  +
                </button>
            ...
            {/* Total Price */}
            <div className="text-xs sm:text-base font-semibold text-[#253272] mb-3 sm:mb-6">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mt-auto">
              {/* Wishlist */}
              <button className="w-9 h-9 sm:w-11 sm:h-11 border border-gray-300 rounded-lg flex items-center justify-center text-[#253272] hover:bg-gray-50 transition-colors shrink-0">
