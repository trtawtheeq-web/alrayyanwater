      ...
      <div dir={dir}>
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#253272] mx-auto mb-4"></div>
        ...
        {hasMore && (
          <div className="text-center mt-6 sm:mt-8">
            <button
              ...
              className="px-6 sm:px-8 py-2.5 sm:py-3 bg-[#253272] text-white rounded-lg font-medium text-sm sm:text-base hover:bg-[#1a2555] transition-colors"
            >
              {t('store.showMore')}
            </button>
          </div>
